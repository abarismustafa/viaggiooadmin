...
function ViaggioHotelBookingListComp() {
    return (
        <>
            {/* {loading && <Loader />} */}
                            ...
                            <table className="table table-striped table-bordered table-hover display dataTable no-footer dtr-inline collapsed" id="myTable" role="grid" aria-describedby="myTable_info" >
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th className="sorting" >Checkout Date</th>
                                        <th className="sorting" >Price</th>
                                        <th className="sorting" >Payment Status</th>
                                        <th className="sorting" >Booking Status</th>
                                        <th className="sorting" >Confirmation Number</th>
                                        <th className="sorting" >Hotel Confirmation Number</th>
                                        <th className="sorting">City / Country</th>
                                        <th className="sorting" >No of Rooms</th>
                                        <th className="sorting" >Last Cancellation Date</th>
...
export default ViaggioHotelBookingListComp