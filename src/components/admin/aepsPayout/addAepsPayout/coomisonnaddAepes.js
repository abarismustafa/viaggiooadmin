...
import '../../quickDhann/ComingSoon.css';

function CoomisonnaddAepes() {
      ...
      <div className={`content contentcomming container ${showContent ? 'show' : ''}`}>
        <div className="row justify-content-center">
          <div className="col-md-8 text-center">
            ...
            <h2 className="display-4 text-secondary mb-4">Quick Dhan is Coming Soon!</h2>
            <p className="lead mb-5 celebrationh2">
              Get ready for a revolutionary financial experience. Quick Dhan is on its way to transform your digital transactions!
            </p>
...
export default CoomisonnaddAepes;
