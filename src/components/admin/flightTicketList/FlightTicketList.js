                    ...
                    <div className="card-body">
                        <form action="" method="post" name="frmReport" id="frmReport">
                            ...
                            <div className="form-row" style={{ alignItems: 'end' }}>
                                ...
                                <div className="form-group col-md-4">
                                    <label htmlFor="order_id">Ticket Id</label>
                                    <input type="text" name="order_id" id="order_id" className="form-control" placeholder="Enter Ticket Id" value={filterInitial.order_id} onChange={handleChange} />
                                </div>
                                <div className="form-group col-md-4">
                                    <label htmlFor="txn_id">PNR Number</label>
                                    ...
                                    <input type="text" name="txn_id" id="txn_id" className="form-control" placeholder="Enter PNR Number" value={filterInitial.txn_id} onChange={handleChange} />
                                </div>
                                <div className="form-group col-md-4">
                                    <label htmlFor="txn_id">Booking ID</label>

                                    <input type="text" name="txn_id" id="txn_id" className="form-control" placeholder="Enter Booking ID" value={filterInitial.txn_id} onChange={handleChange} />
                                </div>
                            ...
                            <table className="table table-striped table-bordered table-hover display dataTable no-footer dtr-inline collapsed" id="myTable" role="grid" aria-describedby="myTable_info" >
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th className="sorting" >Booking ID</th>
                                        <th className="sorting" >Ajent ID</th>
                                        <th className="sorting" >Opening Balance</th>
                                        <th className="sorting" >Publish Fee</th>
                                        <th className="sorting" >Amount</th>
                                        <th className="sorting" >Flight</th>
                                        <th className="sorting" >Date</th>
                                        <th className="sorting" >Cancle</th>
                                    </tr>
                                </thead>
                                <tbody>
