                    ...
                    <div className="card-body">
                        <form action="" method="post" name="frmReport" id="frmReport">
                            ...
                            <div className="form-row" style={{ alignItems: 'end' }}>
                                ...
                                <div className="form-group col-md-4">
                                    <label htmlFor="order_id">Txn Id</label>
                                    <input type="text" name="order_id" id="order_id" className="form-control" placeholder="Enter Txn Id" value={filterInitial.order_id} onChange={handleChange} />
                                </div>
                                <div className="form-group col-md-4">
                                ...
                                <div className="form-group col-md-4">
                                    <label htmlFor="txn_id">Travel Name</label>

                                    <input type="text" name="txn_id" id="txn_id" className="form-control" placeholder="Enter Travel Name" value={filterInitial.txn_id} onChange={handleChange} />
                                </div>
                            ...
                            <table className="table table-striped table-bordered table-hover display dataTable no-footer dtr-inline collapsed" id="myTable" role="grid" aria-describedby="myTable_info" >
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th className="sorting" >Seat Name</th>
