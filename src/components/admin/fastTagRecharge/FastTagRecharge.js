...
import FastTagRechargeList from "./fastTagRechargeList/FastTagRechargeList";
import { ToastContainer, toast } from "react-toastify";
import TipinModal from "../../../common/tipinModal/TipinModal";
import Loader from "../../../common/loader/Loader";
function FastTagRecharge({walletShowHeader}) {
    ...
    // console.log(showBanak?.paymentAmountExactness);
    ...
    const electricityOperator = async () => {
        const electricity = '667e8a8aa0cc9372aaceb004'
        try {
                                    ...
                                    {detailsShow ? <div className="bill-details">
                                        ...
                                        <div className="form-group">
                                            <div className="fl-wrap fl-wrap-input">
                                                ...
                                                <input type="text" style={{ cursor: 'not-allowed', backgroundColor: '#f0f0f0' }}  name="amount" className="form-control txtAmountDthRec fl-input" value={detailsData?.amount} placeholder="Amount"  readOnly  /></div>
                                            {/* <p>Exact and above </p> */}
  ...
  <div className="FormButtons mt-3 text-align-center">
    <button 
      ...
      disabled={detailsData?.amount == 0} 
      onClick={() => setModalShow(true)}
    >
      {isLoading ? <div className="loaderr"></div> : 'Proceed To Pay'}
    </button>
  </div>
) : (
  <div className="FormButtons mt-3 text-align-center">
    <button 
      ...
      className="btn btn-success" 
      onClick={ViewDtails}
      disabled={isViewBillDisabled} 
    > 
      {isLoading ? <div className="loaderr"></div> : 'View Bill'}
    </button>
  </div>
)}
                                </form>
