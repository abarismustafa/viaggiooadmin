...
function LandlineBillList() {
    ...
    const getTransitionReport = async (input) => {
        ...
        const clone = {
            ...
            category: '6655db77d0ff3e6928e2c27e', page: input, user_id: window.localStorage.getItem('userIdToken')
        }
        try {
    ...
    const ResetData = async () => {
        ...
        const obj = {
            ...
            sortType: '',
            sortType: '',
            category: '6655db77d0ff3e6928e2c27e',
            biller_id: '',
...
export default LandlineBillList