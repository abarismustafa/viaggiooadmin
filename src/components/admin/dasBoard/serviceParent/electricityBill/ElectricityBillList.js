...
function ElectricityBillList() {
    ...
    const getTransitionReport = async (input) => {
        ...
        const clone = {
            ...
            category: '667e8a8aa0cc9372aaceb006', biller_id: showBanak?._id ? showBanak?._id : '', page: input, user_id: window.localStorage.getItem('userIdToken')
        }
        try {
    ...
    const ResetData = async () => {
        ...
        const obj = {
            ...
            sortType: '',
            sortType: '',
            category: '667e8a8aa0cc9372aaceb006',
            biller_id: '',
    ...
    const rechargeOperator = async () => {
        const electricity = '667e8a8aa0cc9372aaceb006'
        try {
