...
function ElectricityBill({ walletShowHeader }) {
    ...
    const resetForm = () => {
      ...
      const paySubmit = async (tipin) => {
        ...
        try {
            ...
            console.error("Error in paySubmit:", error);
            toastSuccessMessageError("An error occurred while processing your payment.");
            setloader1(false);
        } finally {
