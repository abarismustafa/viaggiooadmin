...
import { bbps_txnElectri, dthrechargeOperators } from "../../../../../../api/login/Login";
...
function DthRechargeList() {
    ...
    const getTransitionReport = async (input) => {
        setLoading(true)
        const clone = {
            ...filterInitial, biller_id: showBanak?._id ? showBanak?._id : '', count: count,
            category: '667e8a8aa0cc9372aaceb002', page: input, user_id: window.localStorage.getItem('userIdToken')
        }
        try {
    ...
    const ResetData = async () => {
        ...
        const obj = {
            ...
            sortType: '',
            sortType: '',
            // category: '6655db77d0ff3e6928e2c279',
            category: '667e8a8aa0cc9372aaceb002',
            biller_id: '',
                    ...
                    <form action="" method="post" name="frmReport" id="frmReport">
                        ...
                        <div className="form-row" style={{ alignItems: 'end' }}>
                            ...
                            <div className="form-group col-md-4">
                                ...
                                <input type="date" name="end_date" id="account_no" className="form-control" max={currentDate} defaultValue={currentDate} value={filterInitial?.end_date} onChange={handleChange} />
                            </div>
...
export default DthRechargeList