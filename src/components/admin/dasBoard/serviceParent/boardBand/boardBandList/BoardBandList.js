...
function BoardbandList() {
    ...
    const getTransitionReport = async (input) => {
        ...
        const clone = {
            ...
            category: '667e8a8aa0cc9372aaceafff', page: input, user_id: window.localStorage.getItem('userIdToken')
        }
        try {
    ...
    const ResetData = async () => {
        ...
        const obj = {
            ...
            sortType: '',
            sortType: '',
            category: '667e8a8aa0cc9372aaceafff',
            biller_id: '',
