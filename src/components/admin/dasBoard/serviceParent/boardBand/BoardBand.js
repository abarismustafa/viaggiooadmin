...
import BoardbandList from "./boardBandList/BoardBandList"
import { ToastContainer, toast } from "react-toastify"
import TipinModal from "../../../../../common/tipinModal/TipinModal"
import Loader from "../../../../../common/loader/Loader"
function BoardBand({walletShowHeader}) {
   ...
   const [isSubmitting, setIsSubmitting] = useState(false);
    ...
    const electricityOperator = async () => {
        const electricity = '667e8a8aa0cc9372aaceafff'
        try {
                    ...
                    <div className="card-body">
                        ...
                        <div className="form-row">
                            ...
                            <div className="col-md-5 col-sm-12">
                                <h2 className="SecTitle">Broadband</h2>
                                    ...
                                    {detailsShow ? <div className="bill-details">
                                        ...
                                        <div className="form-group">
                                            <div className="fl-wrap fl-wrap-input">
                                                ...
                                                <input type="text" style={{ cursor: 'text !important', backgroundColor: 'white' }} name="amount" className="form-control txtAmountDthRec fl-input" value={detailsData?.amount} placeholder="Amount" onChange={changeHandle2}  readOnly  /></div>
