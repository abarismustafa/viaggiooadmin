...
function WaterList() {
    ...
    const getTransitionReport = async (input) => {
        ...
        const clone = {
            ...
            category: '667e8a8aa0cc9372aaceb00e', page: input, user_id: window.localStorage.getItem('userIdToken')
        }
        try {
    ...
    const ResetData = async () => {
        ...
        const obj = {
            ...
            sortType: '',
            sortType: '',
            category: '667e8a8aa0cc9372aaceb00e',
            biller_id: '',
    ...
    const rechargeOperator = async () => {
        const electricity = '667e8a8aa0cc9372aaceb00e'
        try {
