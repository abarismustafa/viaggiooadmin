...
function WaterBill({walletShowHeader}) {
        ...
        <>
            ...
            readOnly /></div>
                                    ...
                                    {buttonChange ? <div className="FormButtons mt-3 text-align-center">
                                        ...
                                        <button type="button" className="btn btn-success" disabled={initialValue?.amount == 0 } onClick={() => setModalShow(true)}>{isLoading ? <div className="loaderr"></div> : 'Submit'}</button>
                                    </div>
