...
function TranactionReports() {
    ...
    const handleInquiry = async (type, txnId) => {
        let endpoint = '';
        switch (type) {
          case 'CW':
            endpoint = `${baseUrl}aeps/enquiry/${txnId}`;
            break;
          case 'CD':
            endpoint = `${baseUrl}aeps/cashdeposit/enquiry/${txnId}`;
            break;
          case 'AP':
            endpoint = `${baseUrl}aeps/adhaarpay/enquiry/${txnId}`;
            break;
          default:
