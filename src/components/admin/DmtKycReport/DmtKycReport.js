        ...
        <>
            ...
            <div className="ContentArea">
                        ...
                        <form action="" method="post" name="frmReport" id="frmReport">
                            ...
                            <div className="form-row" style={{ alignItems: 'end' }}>
                                ...
                                <div className="form-group col-md-2">
                                    ...
                                    <input className="form-control datefield" id="txtTo" name="txtTo" type="date" style={{ cursor: 'pointer' }} placeholder="Select Date" />
                                </div>
                                <div className="form-group col-md-2">
                                    <label htmlFor="txtUserId">Search :</label>
                                    <input type="text" name="txtUserId" id="txtUserId" className="form-control" maxLength={30} />
                                </div>
                                <div className="form-group col-md-2">
                                    <label htmlFor="ddldb">Data</label>
                                    <select id="ddldb" name="ddldb" className="form-control" fdprocessedid="1wu2ys">
                                ...
                                <div className="form-group col-md-2">
                                    <label>&nbsp;</label>
                                    <input type="submit" name="btnSearch" id="btnSearch" defaultValue="Search" className="btn btn-primary" title="Click to search." fdprocessedid="oub8fh" />
                                </div>
                                <div className="form-group col-md-2">
                                    <label>&nbsp;</label>
                                    <input type="button" name="btnExport" id="btnExport" defaultValue="Export" className="btn btn-secondary" onclick="startexoprt()" fdprocessedid="xocgj" />
                                </div>
                            </div>
                        </form></div>
                ...
                <div className="card mt-4" style={{ overflow: 'auto' }}>
                    <div className="card-body">
                        <div id="myTable_wrapper" className="dataTables_wrapper no-footer"><div className="d-flex  justify-content-between align-items-center">
                            ...
                            </div><div id="myTable_processing" className="dataTables_processing" style={{ display: 'none' }}>Processing...</div><table className="table table-striped table-bordered table-hover display dataTable no-footer dtr-inline collapsed" id="myTable" role="grid" aria-describedby="myTable_info" style={{ width: 1120 }}>
                            <thead>
