...
function MyRefundsComp() {
  return (
    <>
    {/* {loading && <Loader />} */}
    <div className="PageHeading">
        <h1>Hotel Refund List</h1>
    </div>
